...
const AdminCategory = () => {
  ...
  const fetchCategories = async () => {
    fetchData("http://192.168.0.10:8080/api/categories", setData);
  };
  
  const fetchRemovedCategories = async () => {
    fetchData("http://192.168.0.10:8080/api/getremovedcategories", setDataRemoved);
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch("http://192.168.0.10:8080/api/deletecategorie", {
        method: "PUT",
        headers: {
  ...
  const handleActivate = async (id) => {
    try {
      const response = await fetch("http://192.168.0.10:8080/api/activatecategorie", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
