...
const Dashboard = () => {
  ...
  const fetchPendingOrders = async () => {
    try {
      const response = await fetch("http://192.168.0.10:8080/api/orders/onlinequantity");
  ...
  const fetchConfirmedReservations = async () => {
    try {
      const response = await fetch("http://192.168.0.10:8080/api/getfuturereservations");
      const data = await response.json();
  ...
  const fetchCantOrders = async () => {
    try {
      const response = await fetch("http://192.168.0.10:8080/api/getcantorders");
      const data = await response.json();
      setCantOrders(data);
      console.log(data);
    } catch (error) {
  ...
  const fetchBestProducts = async () => {
    try {
      const response = await fetch("http://192.168.0.10:8080/api/getbestproducts");
      const data = await response.json();
  ...
  const fetchMostUsedIngredients = async () => {
    try {
      const response = await fetch("http://192.168.0.10:8080/api/mostusedingredients");
      const data = await response.json();
