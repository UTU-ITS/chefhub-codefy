...
export default function CustomReport() {
  ...
  useEffect(() => {
    fetchData("http://localhost/api/reports/tables", setAvailableTables);
  }, []);
  ...
  const handleTableChange = (event) => {
    ...
    if (newTable !== "") {
      fetchData(`http://localhost/api/reports/columns/${newTable}`, (data) => {
  ...
  const generateReport = () => {
    ...
    postData("http://localhost/api/reports/generatereport", data, (response) => {
